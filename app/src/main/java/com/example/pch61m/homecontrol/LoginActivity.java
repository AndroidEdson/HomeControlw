...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
   ...
   // INSERT INTO profiles (id, description, actuators ) VALUES (3,'Atardecer', 'JKL1250L2250B101B21T250R1FFFFFFR2FFFFFF');
    ...
    private  final String[] DUMMY_CREDENTIALS() {
        ...
        int j=0;
        String users[]= new String[2*usersList.size()];
        for(int i=0; i< usersList.size();i++){
            users[j]= usersList.get(i).getEmail()+":"+usersList.get(i).getPass();
            users[j+1]=  usersList.get(i).getName().toUpperCase()+":"+usersList.get(i).getPass();
        j=+2;
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (String credential : CREDENTIAL) {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent= new Intent(getApplicationContext(), MainActivity.class);
                Users aux= inventory.getUserID(email,password);
                intent.putExtra(MainActivity.EXTRA_ID, aux.getId());
                startActivity(intent);
